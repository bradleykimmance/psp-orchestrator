/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1881cd565075f1e0386b1625a2a448c7)
// Runtime types generated with workerd@1.20260617.1 2025-06-01 
interface __BaseEnv_Env {
	paymentsDB: D1Database;
	ADYEN_API_URL: "https://checkout-test.adyen.com/v71";
	STRIPE_API_URL: "https://api.stripe.com/v1";
	ALLOWED_ORIGIN: "https://payments.bradleykimmance.dev";
	STRIPE_SECRET_KEY: string;
	ADYEN_API_KEY: string;
	ADYEN_MERCHANT_ACCOUNT: string;
	ADYEN_HMAC_KEY: string;
	ADYEN_WEBHOOK_USER: string;
	ADYEN_WEBHOOK_PASSWORD: string;
}
